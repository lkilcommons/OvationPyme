...
if __name__ == '__main__':
	...
	mappableN = aN.pcolormesh(XN,YN,fluxgridN.T,vmin=0,vmax=2)
	mappableS = aS.pcolormesh(XS,YS,fluxgridS.T,vmin=0,vmax=2)
	mappableNS = a2.pcolormesh(XN,YN,(fluxgridS.T+fluxgridN.T)/2,vmin=0,vmax=2)
