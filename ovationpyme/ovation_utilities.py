...
def calc_avg_solarwind(self,dt,oi=None):
	"""
	...
	"""
	n_hour = 4       # hours previous to integrate over
	...
	om_in_avg = range(i_first-n_hour,i_first+1)
	weights = [prev_hour_weight*n_hours_back for n_hours_back in reversed(range(n_hour+1))] #reverse the list
...
def calc_coupling(self,Bx,By,Bz,V):
	"""
